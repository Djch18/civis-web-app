    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">VotaChain</h1>
        ...
        <div className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-md text-left">
            <p>
              <strong>DID de Administrador:</strong> <code className="text-blue-600 dark:text-blue-400">admin</code>
            </p>
            <p>
              <strong>DID de Usuario:</strong> <code className="text-blue-600 dark:text-blue-400">user</code>
            </p>
          </div>
        </div>
      </div>
